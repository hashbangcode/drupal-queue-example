...
namespace Drupal\Tests\queue_class_example\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test the functionality of the queue class example form.
 *
...
class QueueFormTest extends BrowserTestBase {
  ...
  public function testQueueForm() {
    ...
    $this->drupalGet('drupal-queue-examples/queue-class-example');
