...
namespace Drupal\queue_processor_example\Form;
...
class QueueForm extends FormBase {
   ...
   *
   * @var \Drupal\queue_processor_example\QueueProcessorInterface
   */
  ...
  public static function create(ContainerInterface $container) {
    ...
    $instance->queueProcessor = $container->get('queue_processor_example.queue_runner');
    return $instance;
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $queue = $this->queueFactory->get('queue_processor_example');
    $form['current_number'] = [
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    switch ($operation) {
      ...
      case 'process':
        ...
        if ($this->queueProcessor->queueHasItems('queue_processor_example') === FALSE) {
          $this->messenger()->addStatus('The queue is empty.');
          break;
        }

        $this->queueProcessor->run('queue_processor_example');
