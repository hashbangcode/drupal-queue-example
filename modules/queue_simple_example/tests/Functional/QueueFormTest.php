...
namespace Drupal\Tests\queue_simple_example\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Test the functionality of the queue simple example form.
 *
...
class QueueFormTest extends BrowserTestBase {
  ...
  public function testQueueForm() {
    ...
    $this->drupalGet('drupal-queue-examples/queue-simple-example');
